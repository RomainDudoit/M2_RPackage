...
#' selected and if batch size if set to 1, stochastic_gradient_descent is called. If mini-batch mode selected and if batch size if equal to the number of observations, stochastic_gradient_descent is called.
#'
